...
my $cmd = '/u01/IDMTOP/config/scripts/stopall.sh Fusionapps1 Fusionapps1';
...
if(!($outarr[@outarr - 1] =~ /$checkPhrase/)){
	print "\nRan the scripts to stop services on the host\nCheck manually to confirm services are down\n";
}
else{
