#!/bin/sh
#
# $Header: saasinfra/projects/qa/tas/test/java/oracle/tas/test/gsiorders/scripts/gsi_bundle.sh /st_opcinfra_14.1.0.0.0/2 2014/09/02 08:03:49 ashkumak Exp $
#
# gsi_bundle.sh
#
...
#
export ORACLE_HOME=/scratch/aime/work/oracle/product/11.2.0/dbhome_1
