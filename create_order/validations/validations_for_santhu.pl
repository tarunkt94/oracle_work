...
sub check_mounts{
    ...
    generate_msg('fa_mounts',"Verify mounts on FA Host $ovmHash{'fa_host'} ",$params{logdir});
	...
	generate_msg('fa_ha_mounts',"Verify mounts on FA_HA Host $ovmHash{'fa_ha_host'} ",$params{logdir});
    }
    ...
    generate_msg('idm_mounts',"Verify mounts on IDM Host $ovmHash{'idm_host'}",$params{logdir});
	...
	generate_msg('opt1_mounts',"Verify mounts on OPT1 VM host $ovmHash{'opt1_host'}",$params{logdir});
    }
	...
	generate_msg('opt2_host',"Verify mounts on OPT2 VM host $ovmHash{'opt2_host'}",$params{logdir});
    }
	...
	generate_msg('opt3_host',"Verify mounts on OPT3 VM host $ovmHash{'opt3_host'}",$params{logdir});
    }
	...
	generate_msg('opt4_host',"Verify mounts on OPT4 VM host $ovmHash{'opt4_host'}",$params{logdir});
    }
	...
	{	run_test('$ovmHash{$key}',"$scriptDir/check_mount.pl",
		...
		generate_msg($ovmHash{$key},"Verify mounts on AUX SCALE host",$params{logdir});
	    }		
    }	
}
...
sub check_db_mode{
    ...
    generate_msg('dbmode_fa_rac1',"Check DB Mode on $ovmHash{'rac_node1'}",$params{logdir});
    ...
    generate_msg('dbmode_fa_rac2',"Check DB Mode on $ovmHash{'rac_node2'}",$params{logdir});
    ...
    generate_msg('dbmode_oid_rac1',"Check DB Mode on $ovmHash{'rac_node1'}",$params{logdir});
    ...
    generate_msg('dbmode_oid_rac2',"Check DB Mode on $ovmHash{'rac_node2'}",$params{logdir});
...
sub check_tnsping{
    ...
    run_test('prim_tnsping_fa_rac1',"$scriptDir/checkTNSPing.pl",
    ...
    generate_msg('prim_tnsping_fa_rac1',"Checks TNS Ping Status on $p_ovmHash{'rac_node1'}",$params{logdir});
    
	 run_test('prim_tnsping_fa_rac2',"$scriptDir/checkTNSPing.pl",
    ...
    generate_msg('prim_tnsping_fa_rac2',"Checks TNS Ping Status on $p_ovmHash{'rac_node2'}",$params{logdir});


	 run_test('prim_tnsping_oid_rac1',"$scriptDir/checkTNSPing.pl",
	     $p_ovmHash{'rac_node1'},$remoteDB,
    ...
    generate_msg('prim_tnsping_oid_rac1',"Checks TNS Ping Status on $p_ovmHash{'rac_node1'}",$params{logdir});
	

   run_test('prim_tnsping_oid_rac2',"$scriptDir/checkTNSPing.pl",
	     $p_ovmHash{'rac_node2'},$remoteDB,
	     ORACLE_HOME => $p_ovmHash{'oiddb_oracle_home'},
	     p_db_uniq_name =>  $p_ovmHash{'oiddb_uniq_name'},
		 s_db_uniq_name =>  $s_ovmHash{'oiddb_uniq_name'},
    ...
    generate_msg('prim_tnsping_oid_rac2',"Checks TNS Ping Status on $p_ovmHash{'rac_node2'}",$params{logdir});

   run_test('stby_tnsping_fa_rac1',"$scriptDir/checkTNSPing.pl",
	     $s_ovmHash{'rac_node1'},$remoteDB,
	     ORACLE_HOME => $p_ovmHash{'fadb_oracle_home'},
	     p_db_uniq_name =>  $p_ovmHash{'fadb_uniq_name'},
		 s_db_uniq_name =>  $s_ovmHash{'fadb_uniq_name'},
 		 db_name => $p_ovmHash{'fadb_name'},
    ...
    generate_msg('stby_tnsping_fa_rac1',"Checks TNS Ping Status on $s_ovmHash{'rac_node1'}",$params{logdir});
    
	 run_test('stby_tnsping_fa_rac2',"$scriptDir/checkTNSPing.pl",
	     $s_ovmHash{'rac_node2'},$remoteDB,
	     ORACLE_HOME => $p_ovmHash{'fadb_oracle_home'},
	     p_db_uniq_name =>  $p_ovmHash{'fadb_uniq_name'},
		 s_db_uniq_name =>  $s_ovmHash{'fadb_uniq_name'},
 		 db_name => $p_ovmHash{'fadb_name'},
    ...
    generate_msg('stby_tnsping_fa_rac2',"Checks TNS Ping Status on $s_ovmHash{'rac_node2'}",$params{logdir});


	 run_test('stby_tnsping_oid_rac1',"$scriptDir/checkTNSPing.pl",
	     $s_ovmHash{'rac_node1'},$remoteDB,
	     ORACLE_HOME => $p_ovmHash{'oiddb_oracle_home'},
	     p_db_uniq_name =>  $p_ovmHash{'oiddb_uniq_name'},
		 s_db_uniq_name =>  $s_ovmHash{'oiddb_uniq_name'},
    ...
    generate_msg('stby_tnsping_oid_rac1',"Checks TNS Ping Status on $s_ovmHash{'rac_node1'}",$params{logdir});
	

   run_test('stby_tnsping_oid_rac2',"$scriptDir/checkTNSPing.pl",
	     $s_ovmHash{'rac_node2'},$remoteDB,
	     ORACLE_HOME => $p_ovmHash{'oiddb_oracle_home'},
	     p_db_uniq_name =>  $p_ovmHash{'oiddb_uniq_name'},
		 s_db_uniq_name =>  $s_ovmHash{'oiddb_uniq_name'},
    ...
    generate_msg('stby_tnsping_oid_rac2',"Checks TNS Ping Status on $s_ovmHash{'rac_node2'}",$params{logdir});
