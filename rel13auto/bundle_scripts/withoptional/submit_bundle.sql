...
BEGIN
  ...
  l_properties := tas.tas_key_value_list_t(tas.tas_key_value_t('PRODUCT_RELEASE_VERSION','11.13.17.5.0'),tas.tas_key_value_t('TAGS','PRE-1714'),tas.tas_key_value_t('OPERATIONAL_POLICY','ENTERPRISE'),tas.tas_key_value_t('IDM_FEDERATION', 'false'));
