...
l_properties := tas.tas_key_value_list_t(tas.tas_key_value_t('PRODUCT_RELEASE_VERSION','11.13.17.6.0'),tas.tas_key_value_t('TAGS','autotag_postqm'),tas.tas_key_value_t('OPERATIONAL_POLICY','ENTERPRISE'),tas.tas_key_value_t('IDM_FEDERATION', 'false'));
  l_composite_li := tas.tas_gsi_line_item_t(
                                   line_id        => 1,
  ...
  l_properties_gsi_order(1):= tas.tas_key_value_t( 'SALES_REPS', 'test6@example.com' );
  l_properties_gsi_order.extend();
  ...
  l_gsi_order := tas.tas_gsi_order_t(
                       ...
                       organization_id => &1,
                       order_date => l_date,
                       customer_name => 'BundleCustomer'|| dbms_random.string('U',4),
                       customer_acct_number => 'Bundle_ABC' || dbms_random.string('U',2),
                       buyer_email =>'tarun.karamshetty@oracle.com',
                       account_admin_email =>'tarun.karamshetty@oracle.com',
